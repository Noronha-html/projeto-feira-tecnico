...
function danoAoBoss(idObjeto1, idObjeto2) {
    ...
    if (PlayerAcertou == true && atacou == true && lifeBoss == 20) {
        lifeBoss = lifeBoss - 1;
        atacou = false;
        PlayerAcertou = false;
    } else if (PlayerAcertou == true && atacou == true && lifeBoss == 19) {
        lifeBoss = lifeBoss - 1;
        atacou = false;
        PlayerAcertou = false;
    } else if (PlayerAcertou == true && atacou == true && lifeBoss == 18) {
        lifeBoss = lifeBoss - 1;
        atacou = false;
        PlayerAcertou = false;
    } else if (PlayerAcertou == true && atacou == true && lifeBoss == 17) {
        lifeBoss = lifeBoss - 1;
        atacou = false;
        PlayerAcertou = false;
    } else if (PlayerAcertou == true && atacou == true && lifeBoss == 16) {
        lifeBoss = lifeBoss - 1;
        atacou = false;
        PlayerAcertou = false;
    } else if (PlayerAcertou == true && atacou == true && lifeBoss == 15) {
        lifeBoss = lifeBoss - 1;
        atacou = false;
        PlayerAcertou = false;
...
function danoAoPlayer (/*idObjeto1, idObjeto2*/) {
    ...
    if (boss_cultista_wrapper.left + 20 >= objetoPlayer.left + objetoPlayer.width && boss_cultista_wrapper.left <= objetoPlayer.left + objetoPlayer.width + alcanceBoss && 
    ...
    if (playerVida == 8 && bossAtacouLeft == true) {
        playerVida = playerVida - 1;
        hp.classList.remove('h8');
        hp.classList.add('hp7');
    } else if (playerVida == 7 && bossAtacouLeft == true) {
        playerVida = playerVida - 1;
    ...
    if (playerVida == 8 && bossAtacouRight == true) {
        playerVida = playerVida - 1;
        hp.classList.remove('h8');
        hp.classList.add('hp7');
    } else if (playerVida == 7 && bossAtacouRight == true) {
        playerVida = playerVida - 1;
        hp.classList.remove('h7');
        hp.classList.add('hp6');
    ...
    //fazendo o player tomar dano na direita do boss
    if (playerVida == 8 && bossAtacouUp == true) {
        playerVida = playerVida - 1;
        hp.classList.remove('h8');
        hp.classList.add('hp7');
    } else if (playerVida == 7 && bossAtacouUp == true) {
        playerVida = playerVida - 1;
        hp.classList.remove('h7');
        hp.classList.add('hp6');
    ...
    //fazendo o player tomar dano na direita do boss
    if (playerVida == 8 && bossAtacouDown == true) {
        playerVida = playerVida - 1;
        hp.classList.remove('h8');
        hp.classList.add('hp7');
    } else if (playerVida == 7 && bossAtacouDown == true) {
        playerVida = playerVida - 1;
        hp.classList.remove('h7');
        hp.classList.add('hp6');
