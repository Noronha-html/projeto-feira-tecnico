...
function danoAoBoss(idObjeto1, idObjeto2) {
    ...
    let pontos_portaDown = [{x : portaDown.left, y : portaDown.top}, 
    ...
    if (PlayerAcertou == true && atacou == true && lifeBoss == 10) {
        ...
        portaDownClass.classList.remove('portaDown');
        portaDownClass.classList.add('portaDownOpen');
        ...
        ((pontos_portaDown[indice].x >= objetoPlayer.left && pontos_portaDown[indice].x <= objetoPlayer.left + objetoPlayer.width && 
        pontos_portaDown[indice].y >= objetoPlayer.top && pontos_portaDown[indice].y <= objetoPlayer.top + objetoPlayer.height))
        ? colidiu = true : indice ++;
